...
/**
 * Camera reservation model for booking cameras at specific times.
 *
 * @property int $id
 * @property int $camera_id
 * @property string $user_id
 * @property string|null $approved_by
 * @property CameraReservationStatus $status
 ...
 */
class CameraReservation extends Model
{
    use HasFactory;
    ...
    protected $casts = [
        'camera_id' => 'integer',
        'status' => CameraReservationStatus::class,
    ...
    /**
     * Get the camera this reservation is for.
     */
    ...
    {
        return $this->status === CameraReservationStatus::PENDING;
    }
    ...
    {
        return $this->status === CameraReservationStatus::APPROVED;
    }
    ...
    {
        return $this->status === CameraReservationStatus::ACTIVE;
    }
    ...
    public function canModify(): bool
    {
        return in_array($this->status, [
            CameraReservationStatus::PENDING,
            CameraReservationStatus::APPROVED,
        ]);
    }
    ...
    {
        return $query->where('status', CameraReservationStatus::PENDING);
    }
    ...
    {
        return $query->where('status', CameraReservationStatus::APPROVED);
    }
    ...
    {
        return $query->where('status', CameraReservationStatus::ACTIVE);
    }
