            ...
            <AppLayout>
                ...
                <div className="flex h-screen items-center justify-center">
                    <div className="text-center">
                        <div className="mb-4 animate-pulse text-lg font-semibold">
                            Loading session...
                        </div>
                    </div>
                </div>
                ...
                <div className="flex h-screen flex-col items-center justify-center">
                    <div className="text-center">
                        ...
                        <p className="mb-4 text-muted-foreground">
                            This session may have expired or been terminated.
                        </p>
        ...
        <AppLayout>
            ...
            <div className="flex h-screen flex-col">
                ...
                <motion.div
                    ...
                    className="border-b border-border/40 bg-background/95 p-4 backdrop-blur supports-[backdrop-filter]:bg-background/60"
                >
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <TerminateSessionButton
                                sessionId={session.id}
                                onTerminated={handleSessionTerminated}
                            />
                        </div>
                    </div>
                </motion.div>
                        ...
                        {isCameraSplitActive && !isCameraFeedFocused && (
                            <div className="flex items-center justify-end gap-2">
                                <Button
                                    ...
                                    disabled={
                                        splitLeftWidth <= splitBounds.minPercent
                                    }
                                >
                                    Camera Wider
                                </Button>
                                <Button
                                    ...
                                    disabled={
                                        splitLeftWidth >= splitBounds.maxPercent
                                    }
                                >
                                    VM Wider
                                </Button>
