/**
 * CourseVideoInput Component
 * Handles both uploaded video files and YouTube URLs for courses.
...
import type { VideoType } from '@/types/course.types';
interface CourseVideoInputProps {
...
export default function CourseVideoInput({
    videoType,
    videoUrl,
    onVideoChange,
    onUpload,
