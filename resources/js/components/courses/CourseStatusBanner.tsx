...
export function CourseStatusBanner({ status, adminFeedback, submittedAt }: CourseStatusBannerProps) {
    if (status === 'approved') {
    ...
    const bannerConfig = {
        draft: {
            ...
            title: 'Draft',
            description: 'This course is not yet published. Complete all sections and submit for review when ready.',
        ...
        rejected: {
            ...
            description: 'Your course needs revisions before it can be approved. Please review the feedback below and resubmit.',
