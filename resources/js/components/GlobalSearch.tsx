        ...
        useEffect(() => {
            const fetchSuggestions = async () => {
                ...
                try {
                    ...
                    const recentPromise = user ? searchApi.getRecent().catch(() => []) : Promise.resolve([]);
        ...
        return (
            <>
                ...
                <Button
                    ...
                    className="relative h-9 w-9 text-muted-foreground sm:w-64 sm:justify-start sm:px-3 sm:py-2 cursor-pointer"
                    ...
                    <DialogContent className="gap-0 overflow-hidden p-0 sm:max-w-2xl [&>button]:hidden">
                        ...
                        <div className="flex items-center gap-3 border-b px-4 pt-4 pb-4">
                            ...
                            <Input
                                ...
                                className="h-10 border rounded-lg bg-muted px-3 text-base focus-visible:ring-2 focus-visible:ring-primary"
                            />
                            {loading && (
                                <Loader2
                                ...
                                {!query ? (
                                                ...
                                                {recentSearches.map(
                                                    (suggestion, i) => (
                                                        <button
                                                            ...
                                                            className={cn(
                                                                'flex w-full items-center gap-3 rounded-lg px-2 py-2.5 text-sm transition-colors cursor-pointer',
                                                                selectedIndex === i
                                        ...
                                        {results.map((result, i) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        'flex w-full items-start gap-3 rounded-lg p-3 text-left transition-colors cursor-pointer',
                                                        selectedIndex === i
                                                            ? 'bg-primary/10'
                                                            : 'hover:bg-muted',
                                                    )}
                                    ...
                                    >
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Try searching for a different path, lab, or expert
                                        </p>
                                    </motion.div>
                                ) : null}
                            </AnimatePresence>
