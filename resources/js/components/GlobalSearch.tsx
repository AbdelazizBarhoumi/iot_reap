...
const typeColors: Record<SearchResultType, string> = {
    ...
    lesson: 'bg-violet-500/10 text-violet-500',
    ...
    return (
        <>
            ...
            <Button
                ...
                className="relative h-9 w-9 text-muted-foreground sm:w-64 sm:justify-start sm:px-3 sm:py-2"
                aria-label="Search courses, lessons, instructors"
            >
                ...
                <DialogContent className="gap-0 overflow-hidden p-0 sm:max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription className="sr-only">
                            Search courses, lessons, instructors, and resources.
                        </DialogDescription>
                    </DialogHeader>
                    {/* Search Input */}
                    <div className="flex items-center border-b px-4">
                        ...
                        <Input
                            ...
                            className="h-14 border-0 bg-transparent px-3 text-base focus-visible:ring-0 focus-visible:ring-offset-0"
                        />
                        {loading && (
                            <Loader2
