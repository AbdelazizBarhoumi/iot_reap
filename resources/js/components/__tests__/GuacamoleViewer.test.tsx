...
const GuacamoleViewer = ({
    ...
    return (
        <div data-testid="guacamole-container">
            ...
            <div
                data-testid="guacamole-canvas-container"
...
describe('GuacamoleViewer Component', () => {
    ...
    describe('Conditional Rendering States', () => {
        it('renders WaitingForSession when not active', () => {
            ...
            expect(
                screen.getByText(/waiting for session to be ready/i),
            ).toBeInTheDocument();
        ...
        it('renders GuacamoleViewer when active', () => {
            ...
            expect(
                screen.getByText(/connected to 192\.168\.1\.100/i),
            ).toBeInTheDocument();
            expect(
