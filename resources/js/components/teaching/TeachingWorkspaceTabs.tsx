...
import { BarChart3, BookOpen, MessageSquare, Terminal, Wallet } from 'lucide-react';
...
const tabs: Array<{
...
}> = [
    {
        id: 'analytics',
        label: 'Analytics',
        href: resolveHref(() => teaching.analytics.index.url(), '/teaching/analytics'),
        icon: BarChart3,
    },
    {
        id: 'training-paths',
    ...
    },
    {
        id: 'inbox',
        label: 'Inbox',
        href: resolveHref(() => teaching.forum.inbox.url(), '/teaching/forum/inbox'),
        icon: MessageSquare,
    },
    {
        id: 'payouts',
        label: 'Payouts',
        href: resolveHref(() => teaching.analytics.earnings.url(), '/teaching/analytics/earnings'),
        icon: Wallet,
    },
];
