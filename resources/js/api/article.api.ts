 ...
 */
export const saveArticle = (trainingUnitId: string, article: Partial<Article>) =>
  client.post<Article>(`/teaching/trainingUnits/${trainingUnitId}/article`, article);
 ...
 */
export const markArticleRead = (trainingPathId: string, trainingUnitId: string) =>
  client.post(`/trainingPaths/${trainingPathId}/trainingUnits/${trainingUnitId}/article-read`, {});
