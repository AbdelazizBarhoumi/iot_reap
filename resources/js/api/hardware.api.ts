...
export const hardwareApi = {
    ...
    async getNodes(): Promise<GatewayNode[]> {
        const response =
            await client.get<ApiResponse<GatewayNode[]>>('/hardware');
    ...
    async getDevices(): Promise<UsbDevice[]> {
        const response =
            await client.get<ApiResponse<UsbDevice[]>>('/hardware/devices');
        return response.data.data;
    },
    /**
    ...
    async bindDevice(deviceId: number): Promise<ActionResponse> {
        const response = await client.post<ActionResponse>(
            `/hardware/devices/${deviceId}/bind`,
        );
        return response.data;
    },
    /**
    ...
    async unbindDevice(deviceId: number): Promise<ActionResponse> {
        const response = await client.post<ActionResponse>(
            `/hardware/devices/${deviceId}/unbind`,
        );
        return response.data;
    },
    /**
    ...
    async attachDevice(
        ...
        const response = await client.post<ActionResponse>(
            `/hardware/devices/${deviceId}/attach`,
            data,
        );
        return response.data;
    },
    ...
    async detachDevice(deviceId: number): Promise<ActionResponse> {
        const response = await client.post<ActionResponse>(
            `/hardware/devices/${deviceId}/detach`,
        );
        return response.data;
    },
    /**
    ...
    async cancelPendingAttachment(deviceId: number): Promise<ActionResponse> {
        const response = await client.post<ActionResponse>(
            `/hardware/devices/${deviceId}/cancel-pending`,
        );
        return response.data;
    },
    /**
    ...
    async removeCamera(deviceId: number): Promise<ActionResponse> {
        const response = await client.delete<ActionResponse>(
            `/hardware/devices/${deviceId}/camera`,
        );
        return response.data;
    },
    // Admin endpoints
     ...
     */
    async discoverGateways(): Promise<
        ActionResponse & { gateways?: GatewayNode[] }
    > {
        const response = await client.post<
            ActionResponse & { gateways?: GatewayNode[] }
        >('/admin/hardware/discover');
        return response.data;
    },
    /**
     * Refresh online status of all known gateways.
     */
    async refreshGatewayStatus(): Promise<
        ActionResponse & { data?: GatewayNode[] }
    > {
        const response = await client.post<
            ActionResponse & { data?: GatewayNode[] }
        >('/admin/hardware/status');
        return response.data;
    },
    /**
    ...
    async updateNode(
        nodeId: number,
        data: UpdateGatewayNodeRequest,
    ): Promise<ActionResponse> {
        const response = await client.put<ActionResponse>(
            `/admin/hardware/nodes/${nodeId}`,
            data,
        );
        return response.data;
    ...
    async getRunningVms(): Promise<RunningVm[]> {
        const response = await client.get<ApiResponse<RunningVm[]>>(
            '/admin/hardware/running-vms',
        );
        return response.data.data;
    },
};
...
export const sessionHardwareApi = {
    ...
    async getSummary(sessionId: string): Promise<SessionHardwareSummary> {
        const response = await client.get<ApiResponse<SessionHardwareSummary>>(
            `/sessions/${sessionId}/hardware`,
        );
        return response.data.data;
    },
    /**
    ...
    async getAvailableDevices(sessionId: string): Promise<UsbDevice[]> {
        const response = await client.get<ApiResponse<UsbDevice[]>>(
            `/sessions/${sessionId}/hardware/available`,
        );
        return response.data.data;
    },
    /**
    ...
    async detachDevice(
        ...
        const response = await client.post<ActionResponse>(
            `/sessions/${sessionId}/hardware/devices/${deviceId}/detach`,
        );
        return response.data;
    },
    /**
    ...
    async joinQueue(
        sessionId: string,
        deviceId: number,
    ): Promise<ActionResponse & { queue_entry?: UsbDeviceQueueEntry }> {
        const response = await client.post<
            ActionResponse & { queue_entry?: UsbDeviceQueueEntry }
        >(`/sessions/${sessionId}/hardware/devices/${deviceId}/queue/join`);
        return response.data;
    },
    /**
    ...
    async leaveQueue(
        ...
        const response = await client.post<ActionResponse>(
            `/sessions/${sessionId}/hardware/devices/${deviceId}/queue/leave`,
        );
        return response.data;
    },
};
...
export const reservationApi = {
    ...
    async getMyReservations(): Promise<UsbDeviceReservation[]> {
        const response =
            await client.get<ApiResponse<UsbDeviceReservation[]>>(
                '/reservations',
            );
        return response.data.data;
    },
    ...
    ): Promise<ActionResponse & { reservation?: UsbDeviceReservation }> {
        const response = await client.post<
            ActionResponse & { reservation?: UsbDeviceReservation }
        >('/reservations', data);
        return response.data;
    },
    /**
...
export const adminReservationApi = {
     ...
     */
    async createBlock(
        data: CreateAdminBlockRequest,
    ): Promise<ActionResponse & { reservation?: UsbDeviceReservation }> {
        const response = await client.post<
            ActionResponse & { reservation?: UsbDeviceReservation }
        >('/admin/reservations/block', data);
        return response.data;
    },
};
