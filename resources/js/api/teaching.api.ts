...
export const createTrainingPath = (
    trainingPathData: Partial<TrainingPathEditing>,
 ...
 * Update trainingPath
 */
export const updateTrainingPath = (
    trainingPathId: string | number,
    trainingPathData: Partial<TrainingPathEditing>,
) =>
    client.patch<TrainingPathEditing>(
        `/teaching/${trainingPathId}`,
        trainingPathData,
    );
 ...
 */
export const getTrainingUnitForEditing = (
    trainingPathId: string,
    moduleId: string,
    trainingUnitId: string,
) =>
    client.get<TrainingUnit>(
        `/teaching/${trainingPathId}/module/${moduleId}/trainingUnit/${trainingUnitId}`,
    );

/**
 * Create trainingUnit in a module
 */
export const createTrainingUnit = (
    trainingPathId: string,
    moduleId: string,
    trainingUnitData: Partial<TrainingUnit>,
) =>
    client.post<TrainingUnit>(
 ...
 * Update trainingUnit
 */
export const updateTrainingUnit = (
    trainingPathId: string,
    moduleId: string,
    trainingUnitId: string,
    trainingUnitData: Partial<TrainingUnit>,
) =>
    client.patch<TrainingUnit>(
 ...
 * Delete trainingUnit
 */
export const deleteTrainingUnit = (
    trainingPathId: string,
    moduleId: string,
    trainingUnitId: string,
) =>
 ...
 */
export const reorderTrainingUnits = (
    trainingPathId: string,
    moduleId: string,
    order: string[],
) =>
