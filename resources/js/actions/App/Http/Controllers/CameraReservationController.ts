...
/**
* @see \App\Http\Controllers\CameraReservationController::cameraReservations
 * @see app/Http/Controllers/CameraReservationController.php:166
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
export const cameraReservations = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: cameraReservations.url(args, options),
    method: 'get',
})

cameraReservations.definition = {
    methods: ["get","head"],
 ...
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
cameraReservations.url = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { camera: args }
    }
    ...
    return cameraReservations.definition.url
 ...
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
cameraReservations.get = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: cameraReservations.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
cameraReservations.head = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: cameraReservations.url(args, options),
    method: 'head',
})
 ...
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
    const cameraReservationsForm = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: cameraReservations.url(args, options),
        method: 'get',
    })
 ...
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
        cameraReservationsForm.get = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: cameraReservations.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/camera-reservations/cameras/{camera}/calendar'
 */
        cameraReservationsForm.head = (args: { camera: number | { id: number } } | [camera: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: cameraReservations.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    cameraReservations.form = cameraReservationsForm
const CameraReservationController = { index, cameras, store, show, cancel, cameraReservations }

export default CameraReservationController