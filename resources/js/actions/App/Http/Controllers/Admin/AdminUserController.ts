...
const AdminUserController = { stopImpersonation, index, show, approveTeacher, revokeTeacherApproval, suspend, unsuspend, updateRole, impersonate, Delete }
