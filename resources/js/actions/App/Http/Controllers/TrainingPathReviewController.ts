...
/**
* @see \App\Http\Controllers\TrainingPathReviewController::myReview
 * @see app/Http/Controllers/TrainingPathReviewController.php:51
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
export const myReview = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: myReview.url(args, options),
    method: 'get',
})
 ...
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
myReview.url = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { trainingPathId: args }
    }
    ...
    return myReview.definition.url
            .replace('{trainingPathId}', parsedArgs.trainingPathId.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
myReview.get = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: myReview.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
myReview.head = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: myReview.url(args, options),
    method: 'head',
})
 ...
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
    const myReviewForm = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: myReview.url(args, options),
        method: 'get',
    })
 ...
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
        myReviewForm.get = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: myReview.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/trainingPaths/{trainingPathId}/reviews/my'
 */
        myReviewForm.head = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: myReview.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
...
const TrainingPathReviewController = { index, stats, myReview, store, update, destroy }

export default TrainingPathReviewController