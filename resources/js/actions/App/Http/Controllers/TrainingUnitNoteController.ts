...
/**
* @see \App\Http\Controllers\TrainingUnitNoteController::trainingPathNotes
 * @see app/Http/Controllers/TrainingUnitNoteController.php:36
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
export const trainingPathNotes = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: trainingPathNotes.url(args, options),
    method: 'get',
})

trainingPathNotes.definition = {
    methods: ["get","head"],
 ...
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
trainingPathNotes.url = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
    ...
    return trainingPathNotes.definition.url
 ...
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
trainingPathNotes.get = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: trainingPathNotes.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
trainingPathNotes.head = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: trainingPathNotes.url(args, options),
    method: 'head',
})
 ...
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
    const trainingPathNotesForm = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: trainingPathNotes.url(args, options),
        method: 'get',
    })
 ...
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
        trainingPathNotesForm.get = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: trainingPathNotes.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/trainingPaths/{trainingPathId}/notes'
 */
        trainingPathNotesForm.head = (args: { trainingPathId: string | number } | [trainingPathId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: trainingPathNotes.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    trainingPathNotes.form = trainingPathNotesForm
const TrainingUnitNoteController = { index, store, update, destroy, trainingPathNotes }

export default TrainingUnitNoteController