...
/**
* @see \App\Http\Controllers\SessionHardwareController::joinQueue
 * @see app/Http/Controllers/SessionHardwareController.php:373
 * @route '/sessions/{session}/hardware/devices/{device}/queue/join'
 */
export const joinQueue = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: joinQueue.url(args, options),
    method: 'post',
})

joinQueue.definition = {
    methods: ["post"],
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/join'
 */
joinQueue.url = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    session: args[0],
                    device: args[1],
    ...
    return joinQueue.definition.url
            .replace('{session}', parsedArgs.session.toString())
            .replace('{device}', parsedArgs.device.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/join'
 */
joinQueue.post = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: joinQueue.url(args, options),
    method: 'post',
})
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/join'
 */
    const joinQueueForm = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: joinQueue.url(args, options),
        method: 'post',
    })
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/join'
 */
        joinQueueForm.post = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: joinQueue.url(args, options),
            method: 'post',
        })
    
    joinQueue.form = joinQueueForm
/**
* @see \App\Http\Controllers\SessionHardwareController::leaveQueue
 * @see app/Http/Controllers/SessionHardwareController.php:427
 * @route '/sessions/{session}/hardware/devices/{device}/queue/leave'
 */
export const leaveQueue = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: leaveQueue.url(args, options),
    method: 'post',
})

leaveQueue.definition = {
    methods: ["post"],
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/leave'
 */
leaveQueue.url = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    session: args[0],
                    device: args[1],
    ...
    return leaveQueue.definition.url
            .replace('{session}', parsedArgs.session.toString())
            .replace('{device}', parsedArgs.device.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/leave'
 */
leaveQueue.post = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: leaveQueue.url(args, options),
    method: 'post',
})
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/leave'
 */
    const leaveQueueForm = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: leaveQueue.url(args, options),
        method: 'post',
    })
 ...
 * @route '/sessions/{session}/hardware/devices/{device}/queue/leave'
 */
        leaveQueueForm.post = (args: { session: string | { id: string }, device: number | { id: number } } | [session: string | { id: string }, device: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: leaveQueue.url(args, options),
            method: 'post',
        })
    
    leaveQueue.form = leaveQueueForm
const SessionHardwareController = { index, attach, detach, joinQueue, leaveQueue }

export default SessionHardwareController