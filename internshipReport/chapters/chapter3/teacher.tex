...
\subsubsubsection{Specification of the Use Case Create / Edit / Delete Training Path}
\begin{table}[H]
    \centering
    \caption{Use Case Specification: Create / Edit / Delete Training Path}
    \begin{tabular}{|p{2.7cm}|p{12.5cm}|}
        \hline
        \textbf{Title} & Create / Edit / Delete Training Path \\ \hline

        \textbf{Summary} & Teacher creates, edits, or removes a training path. New paths start in draft; edits follow ownership rules; deletions require no active enrollments. \\ \hline


        \textbf{Actor} & Primary: Teacher. Secondary: Administrator (approval), System. \\ \hline

        \textbf{Precondition} & Teacher is authenticated and authorized; categories and VM templates exist; teacher has UI access. \\ \hline

        \textbf{Post-condition} & 
        \begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt]
            \item Create: Training path exists in draft.
            \item Edit: Metadata updated or flagged for approval.
            \item Delete: Training path removed when business rules permit.
        \end{itemize} \\ \hline
        ...
        \begin{enumerate}[topsep=0pt,itemsep=1pt,parsep=0pt,partopsep=0pt]
            \item Teacher provides title, description, category, price, difficulty and modules.
            \item System validates permission.
            \item System creates a draft training path and may create initial modules.
            \item System displays the path for editing.
        \end{enumerate}

        \textbf{B. Edit}
        \begin{enumerate}[topsep=0pt,itemsep=1pt,parsep=0pt,partopsep=0pt]
            \item Teacher submits changes to existing path they own.
            \item System validates changes and confirms ownership.
            \item If approval required, system marks path pending and notifies admin; otherwise applies changes.
            \item System presents updated or pending state.
        \end{enumerate}

        \textbf{C. Delete}
        \begin{enumerate}[topsep=0pt,itemsep=1pt,parsep=0pt,partopsep=0pt]
            \item Teacher requests deletion of an owned path.
            \item System verifies ownership and checks for active enrollments.
            \item If allowed, system removes the path and content; otherwise informs Teacher why it's blocked.
            \item System confirms deletion or shows the blocking reason.
        \end{enumerate}
        \end{minipage} \\ \hline

        \textbf{Error Scenario} & 
        \begin{itemize}[topsep=0pt,itemsep=1pt,parsep=0pt,partopsep=0pt]
            \item Validation failure: system informs Teacher and preserves input.
            \item Unauthorized: system denies action and explains permissions.
            \item Delete blocked: active enrollments prevent deletion; system explains condition.
            \item System error: system preserves state, informs Teacher, and records incident.
        \end{itemize} \\ \hline
    \end{tabular}
    \label{tab:teacher-tp-crud}
\end{table}
