...
\subsubsection[Refinement of the Use Case Browse Training Content]{Refinement of the Use Case Browse Training Content} Figure
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/chapter2/guest-browse-training-content-use-case}
    \caption{Use Case Browse Training Content}
    \label{fig:guest-browse-training-content-use-case}
\end{figure}
\subsubsubsection{Specification of the Use Case Browse and Discover Training Paths}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Read Legal Documents}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Browse Public Forum}
\begin{table}[H]
    \centering
...
\iffalse
\subsubsubsection{Specification of the Use Case View Landing Page}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Search Training Paths}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case View Training Path Details}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Read Terms of Service}
\begin{table}[H]
    \centering
    ...
    \label{tab:guest-tos}
\end{table}
\subsubsubsection{Specification of the Use Case Read Privacy Policy}
\begin{table}[H]
    \centering
...
\subsubsection[Refinement of the Use Case Authenticate]{Refinement of the Use Case Authenticate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/chapter2/guest-authenticate-use-case}
    \caption{Use Case Authenticate}
    \label{fig:guest-authenticate-use-case}
\end{figure}
\subsubsubsection{Specification of the Use Case Authenticate with Google OAuth}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Authenticate with Email \& Password}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Register Account (email or Google)}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Reset Password via Email Link}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Verify Email}
\begin{table}[H]
    \centering
...
\iffalse
\subsubsection[Refinement of the Use Case Consume Learning Content]{Refinement of the Use Case Consume Learning Content}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/chapter2/guest-consume-learning-content-use-case}
    \caption{Use Case Consume Learning Content}
    \label{fig:guest-consume-learning-content-use-case}
\end{figure}
\subsubsubsection{Specification of the Use Case Browse Forum Threads}
\begin{table}[H]
    \centering
    ...
    \label{tab:guest-browse-forum}
\end{table}
\subsubsubsection{Specification of the Use Case Read Forum Thread Detail}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Specification of the Use Case Read Course Reviews}
\begin{table}[H]
    \centering
...
\subsubsection[Refinement of the Use Case Verify a certificate]{Refinement of the Use Case Verify a certificate}
Figure \ref{fig:guest-verify-a-certificate-use-case} presents the refinement of the Use Case Verify a certificate for the Guest actor. This use case includes the following sub-use cases:
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/chapter2/guest-verify-a-certificate-use-case}
    \caption{Use Case Verify a certificate}
    \label{fig:guest-verify-a-certificate-use-case}
\end{figure}

\subsubsubsection{Specification of the Use Case Verify a Certificate}
\begin{table}[H]
    \centering
...
\end{table}
\subsubsubsection{Download Certificate by Hash Link}
\begin{table}[H]
    \centering
